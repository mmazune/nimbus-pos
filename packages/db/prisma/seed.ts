...
const PERMISSIONS_DATA = [
  ...
  {
    action: 'pos:payment:manual-reference',
    description: 'Record manual reference payments (offline fallback)',
  },
  ...
  {
    action: 'pos:analytics:anomalies:acknowledge',
    description: 'Acknowledge or resolve anomaly events',
  },
  {
    action: 'pos:analytics:risk-dashboard:read',
    description: 'View staff risk dashboard and snapshots',
  },
  {
    action: 'pos:analytics:anomalies:recalculate',
    description: 'Trigger anomaly recalculation for a branch',
  },
  ...
  {
    action: 'pos:dash:today-summary:read',
    description: 'Read today summary + payment mix + open orders + low stock',
  },
  ...
  {
    action: 'pos:reports:anomaly-summary:generate',
    description: 'Generate anomaly summary report',
  },
  {
    action: 'pos:reports:reservation-summary:generate',
    description: 'Generate reservation summary report',
  },
  ...
  {
    action: 'pos:reports:sales-by-category:generate',
    description: 'Generate sales by category / PMIX report',
  },
  {
    action: 'pos:reports:sales-by-hour:generate',
    description: 'Generate sales by hour / daypart report',
  },
  ...
  {
    action: 'pos:reports:reservations:generate',
    description: 'Generate reservations summary report (extended)',
  },
  {
    action: 'pos:reports:events:generate',
    description: 'Generate events summary report (extended)',
  },
  {
    action: 'pos:reports:staff-operations:generate',
    description: 'Generate staff / operator operations report',
  },
  {
    action: 'pos:reports:catalog:read',
    description: 'Read the report catalog (implemented / pending)',
  },
  // ── M21: Customer Feedback + NPS + QR Follow-up ──
  { action: 'pos:feedback:read', description: 'List and view customer feedback' },
  {
    action: 'pos:feedback:request:create',
    description: 'Create feedback requests (QR / SMS / email)',
  },
  ...
  {
    action: 'pos:feedback:public:token:read',
    description: 'Public: look up feedback token (no auth)',
  },
  ...
  {
    action: 'pos:documents:storage-config:read',
    description: 'View storage provider configuration',
  },
  {
    action: 'pos:documents:storage-config:update',
    description: 'Update storage provider configuration',
  },
  ...
  {
    action: 'pos:workforce:coverage-rules:read',
    description: 'List and view coverage rules and gaps',
  },
  ...
  { action: 'pos:staff:insights:read', description: 'View staff insight snapshots' },
  { action: 'pos:staff:awards:create', description: 'Create staff awards' },
  { action: 'pos:staff:awards:read', description: 'View staff awards' },
  { action: 'pos:staff:promotions:generate', description: 'Generate promotion suggestions' },
...
const ROLE_PERM_MATRIX: Record<string, string[]> = {
  Owner: [
    ...
    // M27: Staff Insights + Awards + Promotion Suggestions (Owner: full access)
  ...
  Manager: [
    ...
    'pos:payroll:runs:approve',
    'pos:payroll:slips:read',
    // M27: Staff Insights + Awards + Promotion Suggestions (Manager: all except weights:update)
    'pos:staff:insights:read',
    'pos:staff:awards:create',
    'pos:staff:awards:read',
    'pos:staff:promotions:generate',
  ...
  Supervisor: [
    ...
    'pos:payroll:runs:read',
    'pos:payroll:slips:read',
    // M27: Staff Insights (Supervisor: read insights + awards only)
    'pos:staff:insights:read',
    'pos:staff:awards:read',
  ],
  Cashier: [
...
const INVENTORY_ITEMS_SEED: InventoryItemSeed[] = [
  ...
  {
    name: 'Beef Patty 200g',
    unit: 'pc',
    category: 'Meat',
    theoreticalUnitCost: '3.500',
    sku: 'INV-002',
    reorderLevel: '50.000',
    reorderQty: '100.000',
  },
  ...
  },
  {
    ...
    unit: 'ml',
    category: 'Dairy',
    theoreticalUnitCost: '0.003',
    reorderLevel: '5000.000',
    reorderQty: '10000.000',
  },
  {
    name: 'Base Spirit (Vodka)',
    unit: 'ml',
    category: 'Spirits',
    theoreticalUnitCost: '0.060',
    sku: 'INV-005',
  ...
  },
  {
    ...
    unit: 'ml',
    category: 'Beverages',
    theoreticalUnitCost: '0.015',
    reorderLevel: '2000.000',
    reorderQty: '5000.000',
  },
  {
    name: 'Cocktail Garnish',
    unit: 'pc',
    category: 'Garnish',
    theoreticalUnitCost: '0.200',
    reorderLevel: '30.000',
    reorderQty: '100.000',
  },
  {
...
const RECIPES_SEED: RecipeSeed[] = [
  {
    ...
    ingredients: [
      ...
      {
        inventoryItemName: 'Iceberg Lettuce',
        qtyPerUnit: '2.000',
        wastePct: '10.00',
        unit: 'leaf',
      },
  ...
  },
  {
    ...
    ingredients: [
      {
        inventoryItemName: 'Chicken Breast 250g',
        qtyPerUnit: '1.000',
        wastePct: '8.00',
        unit: 'pc',
      },
  ...
  },
  {
    ...
    ingredients: [
      {
        inventoryItemName: 'Base Spirit (Vodka)',
        qtyPerUnit: '45.000',
        wastePct: '2.00',
        unit: 'ml',
      },
  ...
  },
  {
    ...
    ingredients: [
      ...
      {
        inventoryItemName: 'Alfredo Cream Sauce',
        qtyPerUnit: '120.000',
        wastePct: '5.00',
        unit: 'ml',
      },
  ...
  },
  {
    ...
    ingredients: [
      {
        inventoryItemName: 'Atlantic Salmon Fillet',
        qtyPerUnit: '1.000',
        wastePct: '10.00',
        unit: 'pc',
      },
...
async function seedInventoryItems(
  ...
  for (const inv of INVENTORY_ITEMS_SEED) {
    ...
    console.log(
      `  ✅ InventoryItem "${inv.name}" ($${inv.theoreticalUnitCost}/${inv.unit}) created`,
    );
...
async function seedRecipes(
  ...
  for (const recipe of RECIPES_SEED) {
    ...
    if (existingCount > 0) {
      console.log(
        `  ⏭  Recipe for "${recipe.menuItemName}" already exists (${existingCount} rows) — skipped`,
      );
      skipped++;
      continue;
    }
    ...
    for (const ing of recipe.ingredients) {
      ...
      if (!invItemId) {
        console.log(
          `  ⚠️  InventoryItem "${ing.inventoryItemName}" not found — skipping ingredient`,
        );
        continue;
      }
    ...
    console.log(
      `  ✅ Recipe for "${recipe.menuItemName}" created (${recipe.ingredients.length} ingredients)`,
    );
    created++;
  }
  ...
  for (const modRecipe of MODIFIER_RECIPE_SEED) {
    ...
    if (existing) {
      console.log(
        `  ⏭  Modifier recipe "${modRecipe.menuItemName} → ${modRecipe.modifierOptionName}" already exists — skipped`,
      );
      skipped++;
      continue;
    }
    ...
    console.log(
      `  ✅ Modifier recipe "${modRecipe.menuItemName} → ${modRecipe.modifierOptionName}" created`,
    );
    created++;
  }
...
const STOCK_BATCHES_SEED: StockBatchSeed[] = [
  // Chicken Breast: 3 batches (FIFO demo)
  {
    ...
    expiryDate: '2025-03-08T00:00:00Z',
  },
  {
    inventoryItemName: 'Chicken Breast 250g',
    batchNumber: 'CB-2025-002',
    receivedQty: '25.000',
    unitCost: '4.000',
  ...
  {
    inventoryItemName: 'Chicken Breast 250g',
    batchNumber: 'CB-2025-003',
    receivedQty: '15.000',
    unitCost: '4.200',
    receivedAt: '2025-03-10T08:00:00Z',
    expiryDate: '2025-03-17T00:00:00Z',
  },
  // Fresh Milk: 3 batches (FIFO demo)
  {
    inventoryItemName: 'Fresh Milk',
    batchNumber: 'FM-2025-001',
    receivedQty: '5000.000',
    unitCost: '0.003',
    receivedAt: '2025-03-01T06:00:00Z',
    expiryDate: '2025-03-05T00:00:00Z',
  },
  {
    inventoryItemName: 'Fresh Milk',
    batchNumber: 'FM-2025-002',
    receivedQty: '5000.000',
    unitCost: '0.003',
    receivedAt: '2025-03-03T06:00:00Z',
    expiryDate: '2025-03-07T00:00:00Z',
  },
  {
    inventoryItemName: 'Fresh Milk',
    batchNumber: 'FM-2025-003',
    receivedQty: '8000.000',
    unitCost: '0.004',
    receivedAt: '2025-03-08T06:00:00Z',
    expiryDate: '2025-03-12T00:00:00Z',
  },
  // Base Spirit (Vodka): 2 batches (FIFO demo)
  {
    inventoryItemName: 'Base Spirit (Vodka)',
    batchNumber: 'VS-2025-001',
    receivedQty: '3000.000',
    unitCost: '0.058',
    receivedAt: '2025-02-15T10:00:00Z',
  },
  {
    inventoryItemName: 'Base Spirit (Vodka)',
    batchNumber: 'VS-2025-002',
    receivedQty: '2000.000',
    unitCost: '0.062',
  ...
  {
    inventoryItemName: 'Burger Bun',
    batchNumber: 'BB-2025-001',
    receivedQty: '200.000',
    unitCost: '0.480',
    receivedAt: '2025-03-08T07:00:00Z',
    expiryDate: '2025-03-15T00:00:00Z',
  },
  {
    inventoryItemName: 'Beef Patty 200g',
    batchNumber: 'BP-2025-001',
    receivedQty: '80.000',
    unitCost: '3.400',
    receivedAt: '2025-03-06T09:00:00Z',
    expiryDate: '2025-03-20T00:00:00Z',
  },
  {
    inventoryItemName: 'Iceberg Lettuce',
    batchNumber: 'IL-2025-001',
    receivedQty: '150.000',
    unitCost: '0.090',
    receivedAt: '2025-03-09T07:00:00Z',
    expiryDate: '2025-03-14T00:00:00Z',
  },
  {
    inventoryItemName: 'Tomato Slice',
    batchNumber: 'TS-2025-001',
    receivedQty: '120.000',
    unitCost: '0.075',
    receivedAt: '2025-03-09T07:00:00Z',
    expiryDate: '2025-03-14T00:00:00Z',
  ...
  },
  {
    ...
    batchNumber: 'CO-2025-001',
    receivedQty: '5000.000',
    unitCost: '0.004',
    receivedAt: '2025-03-01T10:00:00Z',
  },
  {
    inventoryItemName: 'Herb Seasoning',
    batchNumber: 'HS-2025-001',
    receivedQty: '500.000',
    unitCost: '0.028',
    receivedAt: '2025-03-01T10:00:00Z',
  },
  {
    inventoryItemName: 'Espresso Beans',
    batchNumber: 'EB-2025-001',
    receivedQty: '2000.000',
    unitCost: '0.038',
    receivedAt: '2025-03-01T10:00:00Z',
  },
  {
    inventoryItemName: 'Cocktail Mixer',
    batchNumber: 'CM-2025-001',
    receivedQty: '5000.000',
    unitCost: '0.014',
    receivedAt: '2025-03-01T10:00:00Z',
  },
  {
    inventoryItemName: 'Cocktail Garnish',
    batchNumber: 'CG-2025-001',
    receivedQty: '80.000',
    unitCost: '0.180',
    receivedAt: '2025-03-05T10:00:00Z',
  },
  {
    inventoryItemName: 'Pizza Dough Ball',
    batchNumber: 'PD-2025-001',
    receivedQty: '40.000',
    unitCost: '0.750',
    receivedAt: '2025-03-08T06:00:00Z',
    expiryDate: '2025-03-11T00:00:00Z',
  },
  {
    inventoryItemName: 'Mozzarella Cheese',
    ...
    receivedQty: '3000.000',
    unitCost: '0.011',
    receivedAt: '2025-03-06T07:00:00Z',
    expiryDate: '2025-03-20T00:00:00Z',
  },
  {
    inventoryItemName: 'Tomato Sauce',
    batchNumber: 'TSC-2025-001',
    receivedQty: '5000.000',
    unitCost: '0.007',
    receivedAt: '2025-03-01T10:00:00Z',
  },
  ...
  {
    inventoryItemName: 'Fettuccine Pasta',
  ...
  },
  {
    ...
    unitCost: '0.280',
    receivedAt: '2025-03-06T07:00:00Z',
    expiryDate: '2025-04-06T00:00:00Z',
  },
  {
    inventoryItemName: 'Atlantic Salmon Fillet',
    batchNumber: 'SF-2025-001',
    receivedQty: '15.000',
    unitCost: '6.800',
    receivedAt: '2025-03-08T06:00:00Z',
    expiryDate: '2025-03-12T00:00:00Z',
  ...
  {
    inventoryItemName: 'Lemon',
    batchNumber: 'LM-2025-001',
    receivedQty: '60.000',
    unitCost: '0.140',
    receivedAt: '2025-03-06T07:00:00Z',
    expiryDate: '2025-03-20T00:00:00Z',
...
async function seedStockBatches(
  ...
  for (const batch of STOCK_BATCHES_SEED) {
    ...
    console.log(
      `  ✅ StockBatch "${batch.batchNumber}" (${batch.inventoryItemName}: ${batch.receivedQty} @ $${batch.unitCost}) created`,
    );
    created++;
  }
...
async function seedOrders(
  ...
  for (const order of ORDERS_SEED) {
    ...
    console.log(
      `  ✅ Order "${order.orderNumber}" (${order.serviceType}, ${order.status}) created with ${itemsData.length} items`,
    );
    created++;
  }
...
async function seedEvents(
  ...
  await prisma.eventAuditLog.create({
    data: {
      orgId,
      branchId: branch.id,
      eventId: (await prisma.event.findFirst({
        where: { branchId: branch.id, eventNumber: 'EVT-000001' },
      }))!.id,
      type: 'EVENT_CREATED',
      actorUserId: owner.id,
  ...
  console.log(
    `  ✅ Event EVT-000002 (OPEN + ticket classes + bookings + tickets + check-in) created`,
  );
  created++;
...
async function seedAnalyticsData(
  ...
  const thresholds = [
    {
      ...
      value: 10,
      unit: '%',
      description: 'Alert when void rate exceeds this % in a shift',
    },
    {
      key: 'discount_limit_per_hour',
      name: 'Discount Limit per Hour',
      value: 5,
      unit: 'count',
      description: 'Max discounts per staff member per hour before alert',
    },
    {
      key: 'cash_variance_limit',
      name: 'Cash Variance Limit',
      value: 5000,
      unit: 'UGX',
      description: 'Cash variance in UGX that triggers an alert',
    },
    {
      key: 'late_close_hours',
      name: 'Late Close Hours',
      value: 2,
      unit: 'hours',
      description: 'Hours past scheduled close time before alert is raised',
    },
    {
      key: 'refund_spike_per_hour',
      name: 'Refund Spike per Hour',
      value: 3,
      unit: 'count',
      description: 'Max refunds per staff member per hour before alert',
    },
    {
      key: 'price_override_enabled',
      name: 'Price Override Monitoring',
      boolValue: true,
      description: 'Enable monitoring of price override anomalies',
    },
  ];
  ...
  const existingEvent = await prisma.anomalyEvent.findFirst({
    where: { orgId, branchId: branch.id },
  });
  if (existingEvent) {
...
async function seedDocumentsData(
  ...
  const branch = await prisma.branch.findFirst({
    where: { organizationId: orgId, slug: branchSlug },
  });
  if (!branch) {
...
async function seedAttendanceData(
  ...
  for (let i = 0; i < Math.min(2, employees.length); i++) {
    ...
    if (existing) {
      console.log(
        `  ⏭  AttendanceRecord for "${emp.employeeCode}" on yesterday already exists — skipped`,
      );
      skipped++;
    } else {
  ...
  if (employees.length >= 2) {
    ...
    if (existingSwap) {
      console.log(
        `  ⏭  ShiftSwapRequest "${emp1.employeeCode}" ↔ "${emp2.employeeCode}" already exists — skipped`,
      );
      skipped++;
    } else {
...
async function seedWorkforceData(
  ...
  if (existingDraft) {
    ...
    const tmplAm = await prisma.shiftTemplate.findUnique({
      where: { orgId_code: { orgId, code: 'WEEKDAY-AM' } },
    });
  ...
  const existingPublished = await prisma.schedule.findFirst({
    where: { orgId, name: publishedName },
  });
  if (existingPublished) {
    console.log(`  ⏭  Schedule "${publishedName}" already exists — skipped`);
    skipped++;
  } else {
    const tmplPm = await prisma.shiftTemplate.findUnique({
      where: { orgId_code: { orgId, code: 'WEEKDAY-PM' } },
    });
    const pubData: any = {
      orgId,
      branchId: branch.id,
...
async function seedPayrollData(
  ...
  const componentDefs = [
    ...
    },
    {
      ...
      taxable: false,
      defaultAmount: 0,
      calculationMethod: 'PAYE_BRACKET',
    },
    {
      code: 'NSSF-ER',
      name: 'NSSF Employer Contribution',
      componentType: 'EMPLOYER_COST' as const,
      taxable: false,
      defaultAmount: 50000,
    },
  ];
...
// ── M27: Staff Insights + Awards + Promotion Suggestions seed ──

async function seedStaffInsightsData(
  orgId: string,
  branchCode: string,
): Promise<{ created: number; skipped: number }> {
  let created = 0;
  ...
  if (!branch) {
    console.log('  ⚠  Branch not found — skipping Staff Insights seed');
    return { created, skipped };
  }
  const branchId = branch.id;

  const org = await prisma.organization.findUnique({ where: { id: orgId } });
  if (!org) return { created, skipped };

  const owner = await prisma.user.findUnique({ where: { email: 'owner@demo.local' } });
  if (!owner) return { created, skipped };
  ...
  if (!employee) {
    console.log('  ⚠  No active employee found — skipping Staff Insights seed');
    return { created, skipped };
  }

  // 1) Seed a sample insight snapshot
  const periodStart = new Date('2025-03-01');
  const periodEnd = new Date('2025-03-31');
  const existingSnap = await prisma.staffInsightSnapshot.findUnique({
    where: {
  ...
  if (existingSnap) {
    console.log(`  ⏭  StaffInsightSnapshot for ${employee.employeeCode} exists — skipped`);
    skipped++;
  } else {
    await prisma.staffInsightSnapshot.create({
      data: {
        orgId,
        branchId,
        employeeId: employee.id,
        ...
        sourceSummary: { salesCount: 25, lateDays: 1, absentDays: 0, anomalyCount: 1 },
        generatedById: owner.id,
      },
    });
    console.log(`  ✅ StaffInsightSnapshot for ${employee.employeeCode} created`);
    created++;
  }

  // 2) Seed a sample award
  const existingAward = await prisma.staffAward.findFirst({
    where: { orgId, employeeId: employee.id, awardType: 'EMPLOYEE_OF_MONTH' },
  });
  if (existingAward) {
    console.log(`  ⏭  StaffAward for ${employee.employeeCode} exists — skipped`);
    skipped++;
  } else {
    await prisma.staffAward.create({
      data: {
        ...
        reason: 'Consistently high performance scores and zero absences.',
        createdById: owner.id,
      },
    });
    console.log(`  ✅ StaffAward (EMPLOYEE_OF_MONTH) for ${employee.employeeCode} created`);
    created++;
  }

  // 3) Seed a sample promotion suggestion
  const existingSuggestion = await prisma.promotionSuggestion.findFirst({
    where: { orgId, employeeId: employee.id, periodStart, periodEnd },
  });
  if (existingSuggestion) {
    console.log(`  ⏭  PromotionSuggestion for ${employee.employeeCode} exists — skipped`);
    skipped++;
  } else {
    await prisma.promotionSuggestion.create({
      data: {
        orgId,
        branchId,
        employeeId: employee.id,
        ...
        rationale: {
          compositeScore: 84.5,
          threshold: 70,
          recommendation: 'High performer — consider for promotion',
        },
        generatedById: owner.id,
      },
    });
    console.log(`  ✅ PromotionSuggestion for ${employee.employeeCode} created`);
    created++;
  }
...
async function main(): Promise<void> {
  ...
  console.log(
    `   Created: ${reservationsResult.created}, Skipped: ${reservationsResult.skipped}\n`,
  );
  ...
  // 42) Seed Staff Insights + Awards + Promotions (M27)
  console.log('── Staff Insights + Awards + Promotion Suggestions (M27) ──');
