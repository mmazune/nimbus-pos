...
## Customer Feedback + NPS + QR Follow-up (M21)

| Method | Path                                | Collection                            |
| ------ | ----------------------------------- | ------------------------------------- |
| POST   | `/api/feedback/requests`            | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback/requests`            | M21-Customer-Feedback-NPS-QR-Followup |
| PATCH  | `/api/feedback/requests/:id/cancel` | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback/public/token/:token` | M21-Customer-Feedback-NPS-QR-Followup |
| POST   | `/api/feedback/public`              | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback`                     | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback/:id`                 | M21-Customer-Feedback-NPS-QR-Followup |
| PATCH  | `/api/feedback/:id/tag`             | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback/tags`                | M21-Customer-Feedback-NPS-QR-Followup |
| PATCH  | `/api/feedback/:id/acknowledge`     | M21-Customer-Feedback-NPS-QR-Followup |
| PATCH  | `/api/feedback/:id/resolve`         | M21-Customer-Feedback-NPS-QR-Followup |
| GET    | `/api/feedback/nps-summary`         | M21-Customer-Feedback-NPS-QR-Followup |
...
| PATCH  | `/api/documents/storage-config`        | M22-Documents-Uploads-Attachments        |
| GET    | `/api/documents/stats`                 | M22-Documents-Uploads-Attachments        |
...
| Method | Path                             | Collection                   |
| ------ | -------------------------------- | ---------------------------- |
| POST   | `/api/hr/employees`              | M23-Employees-Contracts-HR   |
| GET    | `/api/hr/employees`              | M23-Employees-Contracts-HR   |
| GET    | `/api/hr/employees/:id`          | M23-Employees-Contracts-HR   |
| PATCH  | `/api/hr/employees/:id`          | M23-Employees-Contracts-HR   |
| POST   | `/api/hr/employees/:id/contracts`| M23-Employees-Contracts-HR   |
| GET    | `/api/hr/employees/:id/contracts`| M23-Employees-Contracts-HR   |
| GET    | `/api/hr/positions`              | M23-Employees-Contracts-HR   |
| POST   | `/api/hr/positions`              | M23-Employees-Contracts-HR   |
| GET    | `/api/hr/compensation-profiles`  | M23-Employees-Contracts-HR   |
| POST   | `/api/hr/compensation-profiles`  | M23-Employees-Contracts-HR   |
...
| Method | Path                                    | Collection                          |
| ------ | --------------------------------------- | ----------------------------------- |
| POST   | `/api/hr/attendance/clock`              | M24-Attendance-Leave-ShiftSwaps     |
| GET    | `/api/hr/attendance`                    | M24-Attendance-Leave-ShiftSwaps     |
| POST   | `/api/hr/leave`                         | M24-Attendance-Leave-ShiftSwaps     |
| GET    | `/api/hr/leave`                         | M24-Attendance-Leave-ShiftSwaps     |
| PATCH  | `/api/hr/leave/:id/review`              | M24-Attendance-Leave-ShiftSwaps     |
| POST   | `/api/hr/shift-swaps`                   | M24-Attendance-Leave-ShiftSwaps     |
| GET    | `/api/hr/shift-swaps`                   | M24-Attendance-Leave-ShiftSwaps     |
| PATCH  | `/api/hr/shift-swaps/:id/approve`       | M24-Attendance-Leave-ShiftSwaps     |
| GET    | `/api/hr/attendance-policies`           | M24-Attendance-Leave-ShiftSwaps     |
| POST   | `/api/hr/attendance-policies`           | M24-Attendance-Leave-ShiftSwaps     |
| PATCH  | `/api/hr/attendance-policies/:id`       | M24-Attendance-Leave-ShiftSwaps     |

---

## Scheduling + Templates + Duty Roster (M25)

| Method | Path                                     | Collection                               |
| ------ | ---------------------------------------- | ---------------------------------------- |
| GET    | `/api/workforce/shift-templates`         | M25-Scheduling-Templates-DutyRoster      |
| POST   | `/api/workforce/shift-templates`         | M25-Scheduling-Templates-DutyRoster      |
| GET    | `/api/workforce/schedules`               | M25-Scheduling-Templates-DutyRoster      |
| POST   | `/api/workforce/schedules`               | M25-Scheduling-Templates-DutyRoster      |
| PATCH  | `/api/workforce/schedules/:id/publish`   | M25-Scheduling-Templates-DutyRoster      |
| PATCH  | `/api/workforce/schedules/:id/archive`   | M25-Scheduling-Templates-DutyRoster      |
| GET    | `/api/workforce/schedules/:id/assignments`| M25-Scheduling-Templates-DutyRoster     |
| POST   | `/api/workforce/schedules/:id/assignments`| M25-Scheduling-Templates-DutyRoster     |
| GET    | `/api/workforce/coverage-rules`          | M25-Scheduling-Templates-DutyRoster      |
| POST   | `/api/workforce/coverage-rules`          | M25-Scheduling-Templates-DutyRoster      |
| GET    | `/api/workforce/coverage-rules/gaps`     | M25-Scheduling-Templates-DutyRoster      |

---

## Payroll Engine + Pay Runs + Payslips (M26)

| Method | Path                                 | Collection                          |
| ------ | ------------------------------------ | ----------------------------------- |
| GET    | `/api/payroll/components`            | M26-Payroll-Engine-PayRuns-Payslips |
| POST   | `/api/payroll/components`            | M26-Payroll-Engine-PayRuns-Payslips |
| GET    | `/api/payroll/adjustments`           | M26-Payroll-Engine-PayRuns-Payslips |
| POST   | `/api/payroll/adjustments`           | M26-Payroll-Engine-PayRuns-Payslips |
| GET    | `/api/payroll/runs`                  | M26-Payroll-Engine-PayRuns-Payslips |
| POST   | `/api/payroll/runs`                  | M26-Payroll-Engine-PayRuns-Payslips |
| PATCH  | `/api/payroll/runs/:id/approve`      | M26-Payroll-Engine-PayRuns-Payslips |
| PATCH  | `/api/payroll/runs/:id/pay`          | M26-Payroll-Engine-PayRuns-Payslips |
| GET    | `/api/payroll/runs/:id/payslips`     | M26-Payroll-Engine-PayRuns-Payslips |
| GET    | `/api/payroll/payslips/:id`          | M26-Payroll-Engine-PayRuns-Payslips |
| GET    | `/api/payroll/payslips/:id/pdf`      | M26-Payroll-Engine-PayRuns-Payslips |

---

## Staff Insights + Awards + Promotion Suggestions (M27)

| Method | Path                                       | Collection                               |
| ------ | ------------------------------------------ | ---------------------------------------- |
| GET    | `/api/staff/insights`                      | M27-Staff-Insights-Awards-Promotions     |
| POST   | `/api/staff/insights/generate`             | M27-Staff-Insights-Awards-Promotions     |
| GET    | `/api/staff/insights/:employeeId`          | M27-Staff-Insights-Awards-Promotions     |
| GET    | `/api/staff/awards`                        | M27-Staff-Insights-Awards-Promotions     |
| POST   | `/api/staff/awards`                        | M27-Staff-Insights-Awards-Promotions     |
| GET    | `/api/staff/awards/:id`                    | M27-Staff-Insights-Awards-Promotions     |
| GET    | `/api/staff/promotions`                    | M27-Staff-Insights-Awards-Promotions     |
| POST   | `/api/staff/promotions/generate`           | M27-Staff-Insights-Awards-Promotions     |
| GET    | `/api/staff/promotions/:id`                | M27-Staff-Insights-Awards-Promotions     |
| PATCH  | `/api/staff/promotions/:id/decide`         | M27-Staff-Insights-Awards-Promotions     |

---

## Accounting Foundation — COA + Cost Centers + Fiscal Periods (M28)

| Method | Path                                              | Collection                                              |
| ------ | ------------------------------------------------- | ------------------------------------------------------- |
| GET    | `/api/accounting/accounts`                        | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| POST   | `/api/accounting/accounts`                        | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| GET    | `/api/accounting/cost-centers`                    | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| POST   | `/api/accounting/cost-centers`                    | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| GET    | `/api/accounting/periods`                         | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| POST   | `/api/accounting/periods`                         | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| PATCH  | `/api/accounting/periods/:id/open`               | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| GET    | `/api/accounting/posting-source-maps`             | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| PATCH  | `/api/accounting/posting-source-maps/:id`         | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| GET    | `/api/accounting/tax-config`                      | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
| PATCH  | `/api/accounting/tax-config`                      | M28-Accounting-Foundation-COA-Cost-Centers-Periods      |
