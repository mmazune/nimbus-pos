...
| Method | Path                                    | Collection                                  |
| ------ | --------------------------------------- | ------------------------------------------- |
| POST   | `/api/workforce/templates`              | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/templates`              | M25-Scheduling-Templates-Duty-Roster        |
| POST   | `/api/workforce/schedules`              | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/schedules`              | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/schedules/:id`          | M25-Scheduling-Templates-Duty-Roster        |
| PATCH  | `/api/workforce/schedules/:id/publish`  | M25-Scheduling-Templates-Duty-Roster        |
| PATCH  | `/api/workforce/schedules/:id/archive`  | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/roster`                 | M25-Scheduling-Templates-Duty-Roster        |
| POST   | `/api/workforce/coverage-rules`         | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/coverage-rules`         | M25-Scheduling-Templates-Duty-Roster        |
| GET    | `/api/workforce/coverage-gaps`          | M25-Scheduling-Templates-Duty-Roster        |
...
| Method | Path                                    | Collection                                          |
| ------ | --------------------------------------- | --------------------------------------------------- |
| POST   | `/api/payroll/components`               | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/components`               | M26-Payroll-Engine-Pay-Runs-Payslips                |
| POST   | `/api/payroll/adjustments`              | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/adjustments`              | M26-Payroll-Engine-Pay-Runs-Payslips                |
| POST   | `/api/payroll/runs/build`               | M26-Payroll-Engine-Pay-Runs-Payslips                |
| PATCH  | `/api/payroll/runs/:id/approve`         | M26-Payroll-Engine-Pay-Runs-Payslips                |
| PATCH  | `/api/payroll/runs/:id/pay`             | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/runs`                     | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/runs/:id`                 | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/slips`                    | M26-Payroll-Engine-Pay-Runs-Payslips                |
| GET    | `/api/payroll/slips/:id`                | M26-Payroll-Engine-Pay-Runs-Payslips                |
